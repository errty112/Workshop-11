...
public class EnemyController : MonoBehaviour
{
    ...
    public bool SwarmReady { get; set; }
    ...
    private IEnumerator AttackSequence()
    {
        ...
        // Wait for directive to begin attacks, in case part of the swarm has
        // not fully spawned yet (swarm manager updates this flag).
        yield return new WaitUntil(() => SwarmReady);
    ...
    {
        Instantiate(this.projectilePrefab, transform.position,
                Quaternion.identity)
